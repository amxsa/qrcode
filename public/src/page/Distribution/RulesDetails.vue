    ...
    <div class="tab-content">
        <ul class="block">
            ...
            <li style="float: right;margin-right:100px;">
                ...
                <el-button :plain="true" type="info" @click="TJ_GZ()"> + 添加规则</el-button>
        ...
        <div class="box_table">
            ...
            <el-table  v-loading="loadListing" :data="DistributionRecordS" border style="width: 100%">
                ...
                <el-table-column prop="tag_uuid" label="科目ID">
                </el-table-column>
                <!--<el-table-column prop="business_name" label="商户名称">-->
                <!--</el-table-column>-->
                <el-table-column prop="tag_name" label="科目名称">
                </el-table-column>
                ...
                <el-table-column label="操作" width="240">
                    <template scope="scope">
                        ...
                        <el-button type="success" icon="view" size="mini" @click="GE_details(scope.$index, scope.row)">详情</el-button>
        ...
        <!--新增规则-->
        <el-dialog title="添加规则" v-model="AddingRules" :close-on-click-modal="false">
        ...
        <!--创建分账规则-->
        <el-dialog title="创建分账规则" v-model="CreateRules" :close-on-click-modal="false">
            <el-form :model="addForm" label-width="80px" :rules="addFormRules" ref="addForm">
                ...
                <el-form-item label="商户名称" v-if="is_copy==1">
                    <el-select v-model="YYKU_Income" filterable="" remote placeholder="请输入选择商户名称" :remote-method="funBusinessName" :loading="loading" style="width:100%">
        ...
        <!--编辑规则-->
        <el-dialog title="编辑规则" v-model="BJ_EditingRules" :close-on-click-modal="false">
            <el-form :model="addForm" :rules="addFormRules" ref="addForm">
...
//                    this.SubjectID=this.SubjectsID;
                    this.start();
//                    this.SubjectID='';
                }
            ...
            add_end(){//完成结束
                ...
                let localRoutes =JSON.parse(window.sessionStorage.getItem('user'));
                let gz_add={access_token:localRoutes.access_token,business_uuid:this.$route.query.business_uuid,tag_uuid:this.SubjectID,state:this.gz_state};
            ...
            start(){
                let localRoutes =JSON.parse(window.sessionStorage.getItem('user'));
                let SplitParams = { access_token:localRoutes.access_token,business_uuid:this.$route.query.business_uuid,tag_uuid:this.SubjectsID,page:this.currentPage,page_size:this.page_size};
